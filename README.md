...
A link to the deployed back-end app: https://guarded-bastion-33741.herokuapp.com

A link to the repo for our front-end: https://github.com/thunder-fly/Project-3-frontend
...
```sh
curl --include --request POST https://guarded-bastion-33741.herokuapp.com/sign-up \
...
```sh
curl --include --request POST https://guarded-bastion-33741.herokuapp.com/sign-in \
  --header "Content-Type: application/json" \
  --data '{
    "credentials": {
      "email": "an@example.email",
...
```sh
curl --include --request PATCH https://guarded-bastion-33741.herokuapp.com/change-password/$ID \
...
```sh
curl --include --request DELETE https://guarded-bastion-33741.herokuapp.com/sign-out/$ID \
  --header "Authorization: Token token=$TOKEN"
```
...
```sh
curl --include --request GET https://guarded-bastion-33741.herokuapp.com/users \
  --header "Authorization: Token token=$TOKEN"
```
...
```sh
curl --include --request GET https://guarded-bastion-33741.herokuapp.com/users/$ID \
  --header "Authorization: Token token=$TOKEN"
```
...
```sh
curl --include --request GET https://guarded-bastion-33741.herokuapp.com/blogs \
  --header "Authorization: Token token=$TOKEN"
...
```sh
curl --include --request GET https://guarded-bastion-33741.herokuapp.com/blogs/$ID \
  --header "Authorization: Token token=$TOKEN"
...
```sh
curl --include --request POST https://guarded-bastion-33741.herokuapp.com/blogs/ \
  --header "Content-Type: application/json" \
  --header "Authorization: Token token=${TOKEN}" \
  --data '{
    "blog": {
...
```sh
curl --include --request POST https://guarded-bastion-33741.herokuapp.com/blogs/$ID \
  --header "Content-Type: application/json" \
  --header "Authorization: Token token=${TOKEN}" \
  --data '{
    "blog": {
...
```sh
curl --include --request GET https://guarded-bastion-33741.herokuapp.com/pages \
  --header "Authorization: Token token=$TOKEN"
